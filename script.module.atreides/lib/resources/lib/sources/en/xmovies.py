...
from resources.lib.modules import cfscrape, cleantitle, client, dom_parser, log_utils
...
class source:
    ...
    def sources(self, url, hostDict, hostprDict):
        ...
        try:
            ...
            sources.append({'source': 'CDN', 'quality': 'HD', 'language': 'en',
                            'url': source, 'direct': True, 'debridonly': False})
